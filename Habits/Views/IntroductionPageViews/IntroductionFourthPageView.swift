...
final class IntroductionSecondPageView: UIView {
    ...
    private let titleLabel: UILabel = {
        ...
        titleLabel.introductionFontBold(text: "Почему привычки важны?")
    ...
    private let mainImageView: UIImageView = {
        ...
        mainImageView.image = AssetImages.Introductionimg2.image
    ...
    private let descriptionLabel: UILabel = {
        ...
        let attributedText = NSMutableAttributedString(
            string: "Привычки формируют нашу жизнь. Маленькие шаги каждый день помогают достигать больших целей. Мы поможем вам оставаться на пути к успеху.",
        ...
        if let rangeHelpYou = attributedText.string.range(of: "больших целей") {
        ...
        if let rangeYourself = attributedText.string.range(of: "успеху") {
...
//MARK: - Setup UI
extension IntroductionSecondPageView {
